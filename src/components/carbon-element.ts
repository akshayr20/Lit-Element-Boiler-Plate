...
import carbonElementScss from './carbon-element.scss';
...
export default class HelloElement extends LitElement {
		...
		return html`
			<div data-modal id="my-modal" class="bx--modal " role="dialog" aria-modal="true" aria-labelledby="my-modal-label" aria-describedby="my-modal-heading" tabindex="-1">
				<div class="bx--modal-container">
					...
					<div class="container">
						<div class="item">Testing Sass Support</div>
					</div>
				</div>
			</div>
		`;
	...
	static styles = carbonElementScss; // `styles` here is a `CSSResult` generated by custom WebPack loader
}
